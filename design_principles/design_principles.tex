...
\begin{frame}
    ...
    Symptoms of Rotting Design\pause
    ...
    \begin{enumerate}
        ...
        % \pause \item Needless Complexity
        % \pause \item Needless Repitition
        % \pause \item Opacity
    \end{enumerate}
\end{frame}
...
\begin{frame}\frametitle{Single Responsibility Principle}

    \begin{itemize}
        \pause \item Cohesion
        \pause \item Responsibility = Reason to change
    \end{itemize}
