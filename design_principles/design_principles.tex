...
\begin{frame}{\subsecname}
    ...
    \end{itemize}
% Is there only one reason to change your module or class?  How many different
% features stake a clame on different parts of the class?

% Often, your inputs change for different reasons than your outputs.  These form
% two different axes on which your class gets mapped.

% For libraries, often the platform and the interface are two seperate axes.
% Exposing too much about the platform through the interface can result in
% having to write x^y code to support the overlap of x features over y axes of
% change.
...
\begin{frame}{\subsecname}
    ...
    \begin{itemize}
        \pause \item Measure of average percentage of member variables used by
            each function/method
        \pause \item Can help reveal multiple responsibilities
        \pause \item How many functions make full use of your class's member
            variables?
    \end{itemize}
% Cohesion: Do all methods/functions make use of all or most object
% members/variables.
...
\begin{frame}{\subsecname}
    \centering
    \includegraphics[height=0.8\textheight]{isp1}
\end{frame}
...
\begin{frame}{\subsecname}
    \centering
    \includegraphics[width=0.8\textwidth]{isp2}
\end{frame}
...
\begin{frame}{\subsecname}
    Depend upon abstractions.  \pause Do not depend upon details.
\end{frame}
...
\begin{frame}{\subsecname}
    \begin{itemize}
        \pause \item High level moduls should not depend on low-level modules.  Both should depend on abstractions.
        \pause \item Abstractions should not depend on details. Details should depend on abstractions.
    \end{itemize}
\end{frame}
...
\begin{frame}{References}
    \begin{itemize}
        \item Agile Software Development, Robert C. Martin
